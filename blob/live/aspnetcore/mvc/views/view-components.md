...
* <span data-ttu-id="8f1ed-110">Esegue il rendering di un blocco anziché un'intera risposta.</span><span class="sxs-lookup"><span data-stu-id="8f1ed-110">Renders a chunk rather than a whole response</span></span>
