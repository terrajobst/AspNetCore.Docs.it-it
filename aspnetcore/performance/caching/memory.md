...
La cache in memoria può archiviare qualsiasi oggetto. l'interfaccia di cache distribuita è limitata a `byte[]`.
...
* La cache utilizza una risorsa rappresentano uno, della memoria. Limitare l'aumento delle dimensioni della cache:
...
Visualizzare [metodi IMemoryCache](/dotnet/api/microsoft.extensions.caching.memory.imemorycache) e [CacheExtensions metodi](/dotnet/api/microsoft.extensions.caching.memory.cacheextensions) per una descrizione dei metodi della cache.
...
[! [] codice csharp (memory/sample/RPcache/Pages/About.cshtml.cs?name=snippet) [](memory/sample/RPcache/Pages/About.cshtml.cs?name=snippet)]
...
[! [] codice csharp (memory/sample/RPcache/Pages/About.cshtml.cs?name=snippet2 & evidenziazione = 9, 10, 14, 15) [](memory/sample/RPcache/Pages/About.cshtml.cs?name=snippet2&highlight=9,10,14,15)]
