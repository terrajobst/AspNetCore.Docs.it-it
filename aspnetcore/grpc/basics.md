...
I progetti client devono `Grpc.Tools` fare riferimento direttamente a. Il pacchetto di strumenti non è necessario in fase di esecuzione, quindi la dipendenza `PrivateAssets="All"`è contrassegnata con:
