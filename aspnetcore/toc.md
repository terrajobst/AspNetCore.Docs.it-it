...
## [Globalizzazione e localizzazione](fundamentals/localization.md)
...
## [Scegliere tra il runtime di .NET Core e di .NET Framework](https://docs.microsoft.com/dotnet/articles/standard/choosing-core-framework-server)
...
##### [Helper tag di ancoraggio](mvc/views/tag-helpers/built-in/AnchorTagHelper.md)
##### [Helper tag di cache](mvc/views/tag-helpers/built-in/CacheTagHelper.md)
##### [Helper tag di cache distribuita](mvc/views/tag-helpers/built-in/DistributedCacheTagHelper.md)
##### [Helper tag di ambiente](mvc/views/tag-helpers/built-in/EnvironmentTagHelper.md)
##### [Helper tag di immagine](mvc/views/tag-helpers/built-in/ImageTagHelper.md)
...
### [Controller di test](mvc/controllers/testing.md)
...
#### [Aggiunta di un modello](xref:tutorials/razor-pages/modelz)
...
#### [Uso di SQL Server LocalDB](tutorials/first-mvc-app/working-with-sql.md)
...
#### [Creazione di servizi back-end per app native per dispositivi mobili](mobile/native-mobile-backend.md)
...
### [Protezione di app ASP.NET Core con IdentityServer4](https://identityserver4.readthedocs.io/release/)
...
####[Limitazione dela durata di payload protetti](xref:security/data-protection/consumer-apis/limited-lifetime-payloads)
...
## [Impostazione di HTTPS per lo sviluppo](xref:security/https)
