<span data-ttu-id="1ff08-101">Eseguire l'utilità di scaffolding di identità:</span><span class="sxs-lookup"><span data-stu-id="1ff08-101">Run the Identity scaffolder:</span></span>
