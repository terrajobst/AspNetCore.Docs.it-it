<span data-ttu-id="8d07a-101">Eseguire l'utilità di scaffolding di identità:</span><span class="sxs-lookup"><span data-stu-id="8d07a-101">Run the Identity scaffolder:</span></span>
