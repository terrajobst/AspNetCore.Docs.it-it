<span data-ttu-id="f4cdd-101">Eseguire l'utilità di scaffolding di identità:</span><span class="sxs-lookup"><span data-stu-id="f4cdd-101">Run the Identity scaffolder:</span></span>
