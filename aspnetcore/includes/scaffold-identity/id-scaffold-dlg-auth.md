<span data-ttu-id="ea7ed-101">Eseguire l'utilità di scaffolding di identità:</span><span class="sxs-lookup"><span data-stu-id="ea7ed-101">Run the Identity scaffolder:</span></span>
