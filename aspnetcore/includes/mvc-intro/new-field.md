# <a name="adding-a-new-field"></a><span data-ttu-id="b0e9a-101">Aggiunta di un nuovo campo</span><span class="sxs-lookup"><span data-stu-id="b0e9a-101">Adding a new field</span></span>
