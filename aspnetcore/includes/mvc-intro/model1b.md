<span data-ttu-id="8a2ea-101">Aggiungere le proprietà seguenti alla classe `Movie`:</span><span class="sxs-lookup"><span data-stu-id="8a2ea-101">Add the following properties to the `Movie` class:</span></span>
