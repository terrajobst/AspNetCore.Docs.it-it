...
ms.locfileid: "30893677"
---
# <a name="add-a-controller-to-an-aspnet-core-mvc-app-with-visual-studio-for-mac"></a>Aggiungere un controller a un'app ASP.NET Core MVC con Visual Studio per Mac
