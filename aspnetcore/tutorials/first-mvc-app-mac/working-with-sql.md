...
ms.locfileid: "30893898"
---
[!INCLUDE [adding-model](../../includes/mvc-intro/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="b33ec-103">[Precedente - Aggiungi un modello](adding-model.md)
> [Successivo - Metodi e viste del controller](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="b33ec-103">[Previous - Add a model](adding-model.md)
