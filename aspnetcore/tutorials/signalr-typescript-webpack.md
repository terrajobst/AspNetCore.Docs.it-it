...
---
# <a name="use-aspnet-core-opno-locsignalr-with-typescript-and-webpack"></a><span data-ttu-id="8eb40-103">Usare ASP.NET Core [!OP.NO-LOC(SignalR)] con TypeScript e Webpack</span><span class="sxs-lookup"><span data-stu-id="8eb40-103">Use ASP.NET Core [!OP.NO-LOC(SignalR)] with TypeScript and Webpack</span></span>
...
> [!div class="checklist"]
> * <span data-ttu-id="8eb40-108">Impalcatura uno starter ASP.NET Core [!OP.NO-LOC(SignalR)] app</span><span class="sxs-lookup"><span data-stu-id="8eb40-108">Scaffold a starter ASP.NET Core [!OP.NO-LOC(SignalR)] app</span></span>
> * <span data-ttu-id="8eb40-109">Configurare il client TypeScript di [!OP.NO-LOC(SignalR)]</span><span class="sxs-lookup"><span data-stu-id="8eb40-109">Configure the [!OP.NO-LOC(SignalR)] TypeScript client</span></span>
...
> * <span data-ttu-id="8eb40-111">Configurare il server di [!OP.NO-LOC(SignalR)]</span><span class="sxs-lookup"><span data-stu-id="8eb40-111">Configure the [!OP.NO-LOC(SignalR)] server</span></span>
...
1. <span data-ttu-id="8eb40-165">Creare un file denominato *webpack.config.js* nella radice del progetto con il contenuto seguente:</span><span class="sxs-lookup"><span data-stu-id="8eb40-165">Create a file named *webpack.config.js*, in the project root, with the following content:</span></span>
    ...
    * <span data-ttu-id="8eb40-170">La matrice `resolve.extensions` include *. js* per importare il codice JavaScript del client [!OP.NO-LOC(SignalR)].</span><span class="sxs-lookup"><span data-stu-id="8eb40-170">The `resolve.extensions` array includes *.js* to import the [!OP.NO-LOC(SignalR)] client JavaScript.</span></span>
...
1. <span data-ttu-id="8eb40-203">Eseguire il comando seguente nella radice del progetto:</span><span class="sxs-lookup"><span data-stu-id="8eb40-203">Execute the following command at the project root:</span></span>
    ...
    <span data-ttu-id="8eb40-204">Il comando precedente installa il [client di[!OP.NO-LOC(SignalR)] typescript](https://www.npmjs.com/package/@microsoft/signalr), che consente al client di inviare messaggi al server.</span><span class="sxs-lookup"><span data-stu-id="8eb40-204">The preceding command installs the [[!OP.NO-LOC(SignalR)] TypeScript client](https://www.npmjs.com/package/@microsoft/signalr), which allows the client to send messages to the server.</span></span>
...
1. <span data-ttu-id="8eb40-309">Creare un file denominato *webpack.config.js* nella radice del progetto con il contenuto seguente:</span><span class="sxs-lookup"><span data-stu-id="8eb40-309">Create a file named *webpack.config.js*, in the project root, with the following content:</span></span>
    ...
    * <span data-ttu-id="8eb40-314">La matrice `resolve.extensions` include *. js* per importare il codice JavaScript del client [!OP.NO-LOC(SignalR)].</span><span class="sxs-lookup"><span data-stu-id="8eb40-314">The `resolve.extensions` array includes *.js* to import the [!OP.NO-LOC(SignalR)] client JavaScript.</span></span>
...
1. <span data-ttu-id="8eb40-339">Creare una nuova directory denominata *Hubs* nella radice del progetto.</span><span class="sxs-lookup"><span data-stu-id="8eb40-339">Create a new directory, called *Hubs*, in the project root.</span></span> <span data-ttu-id="8eb40-340">Lo scopo è archiviare l'hub [!OP.NO-LOC(SignalR)], che verrà creato nel passaggio successivo.</span><span class="sxs-lookup"><span data-stu-id="8eb40-340">Its purpose is to store the [!OP.NO-LOC(SignalR)] hub, which is created in the next step.</span></span>
...
1. <span data-ttu-id="8eb40-347">Eseguire il comando seguente nella radice del progetto:</span><span class="sxs-lookup"><span data-stu-id="8eb40-347">Execute the following command at the project root:</span></span>
    ...
    <span data-ttu-id="8eb40-348">Il comando precedente installa il [client di[!OP.NO-LOC(SignalR)] typescript](https://www.npmjs.com/package/@microsoft/signalr), che consente al client di inviare messaggi al server.</span><span class="sxs-lookup"><span data-stu-id="8eb40-348">The preceding command installs the [[!OP.NO-LOC(SignalR)] TypeScript client](https://www.npmjs.com/package/@microsoft/signalr), which allows the client to send messages to the server.</span></span>
