...
ms.locfileid: "30897146"
---
[!INCLUDE [validation](../../includes/mvc-intro/validation.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="1bfda-103">[Precedente - Aggiungere un campo](new-field.md)
> [Successivo - Esaminare i metodi Details e Delete](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="1bfda-103">[Previous - Add a field](new-field.md)
