...
* Entity Framework Core &ndash; vedere https://docs.microsoft.com/ef/core/providers/index per ulteriori informazioni sul riferimento al pacchetto specifico del provider di database.
