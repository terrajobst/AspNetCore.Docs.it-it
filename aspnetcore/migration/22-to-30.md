...
* `IHostingEnvironment` `IWebHostEnvironment`, vedere [questo annuncio su GitHub](https://github.com/aspnet/AspNetCore/issues/7749).
...
È anche possibile personalizzare i criteri. Basandosi sull'esempio precedente, il `DefaultPolicy` è configurato in modo da richiedere l'autenticazione e un ambito specifico:
