...
Sono disponibili tre nuovi metodi di estensione di primo livello correlati a scenari MVC in `IServiceCollection`. I modelli usano questi nuovi metodi invece di `AddMvc`. Tuttavia, `AddMvc` continua a comportarsi come nelle versioni precedenti.
...
Per altre informazioni, vedere [questo problema di GitHub](https://github.com/aspnet/EntityFrameworkCore/issues/17788).
