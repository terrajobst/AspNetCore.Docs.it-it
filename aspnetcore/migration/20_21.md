...
* Aggiorna il  *\_loginpartial. cshtml* file:
  ...
  * Aggiorna il `<form />` elemento `<form asp-area="Identity" asp-page="/Account/Logout" asp-route-returnUrl="@Url.Page("/Index", new { area = "" })" method="post" id="logoutForm" class="navbar-right">`.
...
* Nelle *aree/identità/pagine/\_Viewstart*, modificare `Layout = "/Pages/_Layout.cshtml"` a `Layout = "/Pages/Shared/_Layout.cshtml"`.
* Il  *\_layout. cshtml* file presenta le modifiche seguenti:
