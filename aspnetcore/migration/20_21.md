...
Oggetto *framework condiviso* è un set di assembly (*DLL* file) che non sono presenti cartelle dell'app. Il framework condiviso deve essere installato nel computer per eseguire l'app. Per altre informazioni, vedere [framework condiviso](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/).
