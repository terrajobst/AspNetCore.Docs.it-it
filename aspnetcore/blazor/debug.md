...
1. Eseguire un'app webassembly Blazer nella configurazione `Debug`. Passare l'opzione `--configuration Debug` al comando [DotNet Run](/dotnet/core/tools/dotnet-run) : `dotnet run --configuration Debug`.
