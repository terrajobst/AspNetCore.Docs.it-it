...
*   [Autenticazione](authentication/index.md)
    ...
    *   [Azure Active Directory](authentication/azure-active-directory/index.md)
        ...
        *   [Un'app Web ASP.NET Core con Azure Active Directory B2C](https://azure.microsoft.com/documentation/samples/active-directory-dotnet-webapp-openidconnect-aspnetcore-b2c/)
...
*   [Autorizzazione](authorization/index.md)
    ...
    *   [Autorizzazione basata sulle viste](authorization/views.md)
...
*   [Protezione dati](data-protection/index.md)
    ...
    *   [API di estendibilità](data-protection/extensibility/index.md)
        ...
        *   [Estensibilità della gestione delle chiavi](data-protection/extensibility/key-management.md)
...
*   [Impostazione di HTTPS per lo sviluppo](https.md)
