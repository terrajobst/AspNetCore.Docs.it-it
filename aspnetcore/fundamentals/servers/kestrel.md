...
Configurazione di `KestrelServerOptions` in ASP.NET Core 2.1 o versioni successive:
...
* [Codice sorgente di Kestrel](https://github.com/aspnet/AspNetCore/tree/master/src/Servers/Kestrel)
