...
* Aggiungere i provider ETW per [CLR](/dotnet/framework/performance/clr-etw-providers), ASP.NET Core e altri in base alle esigenze. Il GUID del provider ASP.NET Core è `3ac73b97-af73-50e9-0822-5da4367920d0`. 
