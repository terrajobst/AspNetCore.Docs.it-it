...
È possibile accedere a Session attraverso la proprietà `Session` in `HttpContext`. Questa proprietà è un'implementazione di [ISession](/dotnet/api/microsoft.aspnetcore.http.isession).
