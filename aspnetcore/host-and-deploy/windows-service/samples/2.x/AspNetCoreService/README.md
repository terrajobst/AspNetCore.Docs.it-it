# <a name="aspnet-core-windows-service-sample-framework-dependent-deployment"></a>Esempio di servizio Windows ASP.NET Core (distribuzione dipendente dal framework)
