...
5.  Prima di aggiungere tutti i file, assicurarsi che Visual Studio è l'opzione ' compilare al salvataggio ' per i file TypeScript selezionati. *Strumenti > Opzioni > Editor di testo > Typescript > progetto*
