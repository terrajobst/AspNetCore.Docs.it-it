...
Per il corretto funzionamento della compilazione del runtime durante la distribuzione, le app devono modificare i file di progetto in modo da impostare `PreserveCompilationReferences` su `true`:
