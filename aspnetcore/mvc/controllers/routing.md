...
---
# <a name="routing-to-controller-actions"></a>Routing ad azioni del controller
...
Nell'esempio seguente un vincolo sceglie un'azione in base a un *codice paese* dai dati di route. Vedere l'[esempio completo su GitHub](https://github.com/aspnet/Entropy/blob/dev/samples/Mvc.ActionConstraintSample.Web/CountrySpecificAttribute.cs).
