...
ms.topic: hub-page
ms.author: riande
title: Documentazione di ASP.NET | Microsoft Docs
    ...
    <div class="container">
        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="core">
                    <li>
                        <a href="#core_overview">Panoramica</a>
                        <ul id="core_overview" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>ASP.NET Core è un nuovo framework .NET open source e multipiattaforma per la compilazione di moderne applicazioni Web basate sul cloud in Windows, Mac o Linux.</p>
                                    <p><a href="https://docs.microsoft.com/aspnet/core/choose-aspnet-framework" data-raw-source="[Learn the benefits of both ASP.NET Core and ASP.NET](https://docs.microsoft.com/aspnet/core/choose-aspnet-framework)">Informazioni sui vantaggi di ASP.NET Core e ASP.NET</a> per scegliere la soluzione più adatta alle proprie esigenze.</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introduzione ad ASP.NET Core</h3>
                                                    <p>Sviluppare la prima app ASP.NET Core su qualsiasi piattaforma in 5 minuti.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introduzione a ASP.NET Core</h3>
                                                    <p>Informazioni sui nuovi concetti di ASP.NET Core e su come consentono di sviluppare app Web moderne.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Panoramica di ASP.NET MVC</h3>
                                                    <p>Informazioni su come creare app Web e API usando il modello di progettazione MVC.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Imparare a sviluppare app con ASP.NET Core grazie a risorse di formazione gratuite di diversi provider.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="core_tutorials" class="cardsZ">
                            <li>
                                <div class="container intro">
                                    <p>Esercitazioni in primo piano | <a href="https://docs.microsoft.com/aspnet/core/tutorials/" data-raw-source="[View all ASP.NET Core tutorials](https://docs.microsoft.com/aspnet/core/tutorials/)">Visualizza tutte le esercitazioni su ASP.NET Core</a></p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Creare un sito Web in un Mac</h3>
                                                    <p>Sviluppare la prima app ASP.NET Core su un Mac con Visual Studio per Mac.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Creare un sito Web con Visual Studio in Windows</h3>
                                                    <p>Sviluppare la prima un'app ASP.NET Core MVC con Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Creare un'API Web</h3>
                                                    <p>Sviluppare la prima API Web con ASP.NET Core MVC e Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introduzione a Entity Framework Core e ASP.NET Core</h3>
                                                    <p>Creare applicazioni Web ASP.NET Core MVC che usano Entity Framework Core per l'accesso ai dati.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Pagine della Guida dell'API Web ASP.NET con Swagger</h3>
                                                    <p>Generare la documentazione e le pagine della Guida per l'API Web ASP.NET usando Swagger e Swashbuckle.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Distribuire un'app Web ASP.NET Core in Azure con Visual Studio</h3>
                                                    <p>Creare un'app Web in Servizio app di Azure e distribuirvi un'app Web ASP.NET Core.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                ...
                <ul id="aspnet">
                    <li>
                        <a href="#aspnet_overview">Panoramica</a>
                        <ul id="aspnet_overview" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p>ASP.NET è una piattaforma Web matura che fornisce tutti i servizi necessari per la compilazione di applicazioni Web basate su server di livello aziendale usando .NET in Windows.</p>
                                    <p><a href="https://docs.microsoft.com/aspnet/core/choose-aspnet-framework" data-raw-source="[Learn the benefits of both ASP.NET Core and ASP.NET](https://docs.microsoft.com/aspnet/core/choose-aspnet-framework)">Informazioni sui vantaggi di ASP.NET Core e ASP.NET</a> per scegliere la soluzione più adatta alle proprie esigenze.</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Scaricare Visual Studio</h3>
                                                    <p>Visual Studio è un ambiente IDE gratuito per ASP.NET in Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introduzione ad ASP.NET</h3>
                                                    <p>Confrontare le tecnologie ASP.NET per lo sviluppo di applicazioni Web e API Web e per l'aggiunta di funzionalità in tempo reale.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Informazioni di riferimento sulle API ASP.NET</h3>
                                                    <p>Esplorare la libreria di classi di ASP.NET.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Siti Web</h3>
                                                    <p>Informazioni su come creare un sito Web con ASP.NET MVC 5 e Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API Web</h3>
                                                    <p>Informazioni su come creare un'API Web con ASP.NET Web API 2 e Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Tempo reale</h3>
                                                    <p>Informazioni su come creare un'applicazione di chat con ASP.NET SignalR 2 e Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Corsi gratuiti</h3>
                                                    <p>Imparare a sviluppare applicazioni con ASP.NET Core grazie a risorse di formazione gratuite di diversi provider.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#aspnet_framework">Framework</a>
                        <ul id="aspnet_framework" class="cardsC">
                            <li>
                                <div class="container intro">
                                    <p><a href="/aspnet/overview#websites-and-web-applications">Informazioni sulle diverse opzioni per la creazione di siti Web con ASP.NET</a> per scegliere l'opzione più adatta alle proprie esigenze.</p>
                                </div>
                            </li>
                            <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web Form</h3>
                                                    <p>Creare siti Web dinamici usando un intuitivo modello basato su eventi e con funzionalità di trascinamento.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>MVC</h3>
                                                    <p>Un sistema potente e basato su modelli per la creazione di siti Web dinamici che consente una netta separazione dei ruoli.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Pagine Web</h3>
                                                    <p>Un modo rapido, semplice e accessibile di combinare il codice server con HTML per creare contenuto Web dinamico.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>API Web</h3>
                                                    <p>Creare con facilità servizi HTTP per una vasta gamma di client, inclusi i browser e i dispositivi mobili.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Webhook</h3>
                                                    <p>Integrare API Web e servizi SaaS tramite un pattern HTTP leggero che fornisce un semplice modello di pubblicazione/sottoscrizione.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SignalR</h3>
                                                    <p>Aggiungere funzionalità Web in tempo reale alle applicazioni.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="aspnet_tutorials" class="cardsZ">
                            <li>
                                <div class="container intro">
                                    <p>Esercitazioni in primo piano | <a href="https://docs.microsoft.com/aspnet/tutorials/" data-raw-source="[View all ASP.NET tutorials](https://docs.microsoft.com/aspnet/tutorials/)">Visualizza tutte le esercitazioni su ASP.NET</a></p>
                                </div>
                            </li>
                            <li>
                                <a href="https://docs.microsoft.com/aspnet/mvc/overview/getting-started/introduction/getting-started">
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introduzione ad ASP.NET MVC 5</h3>
                                                    <p>Questa serie di esercitazioni illustra i concetti fondamentali della creazione di un'app Web ASP.NET MVC 5 con Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introduzione ad ASP.NET Web API 2</h3>
                                                    <p>Questa esercitazione illustra i concetti fondamentali della creazione di un'API Web con ASP.NET Web API 2 e Visual Studio.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introduzione a SignalR 2</h3>
                                                    <p>In questa esercitazione viene illustrato come usare SignalR per creare un'applicazione di chat in tempo reale.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Introduzione a Entity Framework 6 Code First con MVC 5</h3>
                                                    <p>Nozioni di base sull'uso di Entity Framework 6 per visualizzare e modificare i dati in un'applicazione ASP.NET MVC 5.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Migrazione di applicazioni ASP.NET MVC ai contenitori di Windows</h3>
                                                    <p>Informazioni su come eseguire un'applicazione ASP.NET MVC esistente in un contenitore Docker di Windows.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
