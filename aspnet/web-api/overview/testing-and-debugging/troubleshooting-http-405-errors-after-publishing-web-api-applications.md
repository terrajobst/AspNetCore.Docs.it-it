...
| **PUT** | Questo metodo viene in genere utilizzato per inviare dati non elaborati all'URI; PUT viene spesso utilizzato per inviare i dati JSON o XML per applicazioni Web API. |
