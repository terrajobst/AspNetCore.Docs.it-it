...
---
<a name="how-do-i-linq-to-sql-updating-the-database"></a>[Procedura:] LINQ to SQL: l'aggiornamento del Database
====================
da [Scott Stanfield](https://github.com/scottstanfield)

In questo video che è stato illustrato come creare, aggiornare ed eliminare record tramite LINQ, le transazioni semplici aggiornamenti tra le relazioni e convalida personalizzata di riga e colonna.

[&#9654;Guarda il video (17 minuti)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/how-do-i-linq-to-sql-updating-the-database)
