...
---
<a name="aspnet-4-quick-hit---ajax-data-templates"></a>ASP.NET 4 "Riscontro rapido" - modelli di dati AJAX
====================
da [Joe Stagner](https://github.com/JoeStagner)

In questo video si apprenderà come usare i modelli di client per visualizzare i record del database con il controllo DataView. 
