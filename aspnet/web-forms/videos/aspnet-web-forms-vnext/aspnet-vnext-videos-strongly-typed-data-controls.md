...
---
<a name="aspnet-vnext-videos-strongly-typed-data-controls"></a>VNext ASP.NET video: controlli dati fortemente tipizzati
====================
da [Damian Edwards](https://github.com/DamianEdwards)

In questo video viene illustrato come Damian Edwards controlli di dati fortemente tipizzati in Visual Studio vNext, fornire IntelliSense e di controllo in fase di compilazione.

[&#9654; Guardare video (minuti 1)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/aspnet-vnext-videos-strongly-typed-data-controls)
