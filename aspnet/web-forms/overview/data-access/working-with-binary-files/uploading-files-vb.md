...
**Figura 2**: aggiungere il `SectionLevelTutorialListing.ascx` controllo utente al `Default.aspx` ([fare clic per visualizzare l'immagine ingrandita](uploading-files-vb/_static/image2.png))
...
**Figura 5**: aggiungere un `BrochurePath` colonna il `Categories` tabella ([fare clic per visualizzare l'immagine ingrandita](uploading-files-vb/_static/image6.png))
...
**Figura 6**: creare un `DataColumn` Named `Picture` cui `DataType` è `System.Byte[]` ([fare clic per visualizzare l'immagine ingrandita](uploading-files-vb/_static/image8.png))
...
**Figura 7**: aggiornare l'elenco colonne nel `SELECT` istruzione restituisca anche `BrochurePath` ([fare clic per visualizzare l'immagine ingrandita](uploading-files-vb/_static/image10.png))
...
[![Una volta caricato il File EvolutionValley.jpg al Server Web](uploading-files-vb/_static/image14.gif)](uploading-files-vb/_static/image21.png)

**Figura 14**: il File `EvolutionValley.jpg` è stato caricato per il Server Web ([fare clic per visualizzare l'immagine ingrandita](uploading-files-vb/_static/image22.png))
