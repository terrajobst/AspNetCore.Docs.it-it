...
**Figura 2**: per l'aggiornamento o eliminazione a hanno esito positivo, l'originale valori deve essere uguale per i valori del Database corrente ([fare clic per visualizzare l'immagine con dimensioni normali](implementing-optimistic-concurrency-vb/_static/image6.png))
...
**Figura 7**: sono il TableAdapter utilizzare tutti i dati modelli di accesso ([fare clic per visualizzare l'immagine con dimensioni normali](implementing-optimistic-concurrency-vb/_static/image21.png))
...
**Figura 8**: oggetto DataTable e TableAdapter sono state aggiunte al set di dati tipizzato ([fare clic per visualizzare l'immagine con dimensioni normali](implementing-optimistic-concurrency-vb/_static/image24.png))
...
**Figura 13**: è possibile utilizzare ObjectDataSource i `ProductsOptimisticConcurrencyBLL` oggetto ([fare clic per visualizzare l'immagine con dimensioni normali](implementing-optimistic-concurrency-vb/_static/image37.png))
...
**Figura 14**: sono elencati i prodotti di in un controllo GridView ([fare clic per visualizzare l'immagine con dimensioni normali](implementing-optimistic-concurrency-vb/_static/image40.png))
...
**Figura 17**: viene rilevato quando una violazione della concorrenza, un' `DBConcurrencyException` generata ([fare clic per visualizzare l'immagine con dimensioni normali](implementing-optimistic-concurrency-vb/_static/image49.png))
