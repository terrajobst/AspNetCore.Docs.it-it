...
ms.locfileid: "37387650"
---
<a name="paging-and-sorting-report-data-vb"></a>Paging e ordinamento dei dati del Report (VB)
====================
...
**Figura 6**: ogni prodotto sono elencate ([fare clic per visualizzare l'immagine con dimensioni normali](paging-and-sorting-report-data-vb/_static/image8.png))
...
**Figura 7**: abilitare il Paging la casella di controllo per aggiungere il supporto di Paging ([fare clic per visualizzare l'immagine con dimensioni normali](paging-and-sorting-report-data-vb/_static/image11.png))
...
**Figura 8**: con abilitato il Paging, solo un Subset dei record vengono visualizzati in un momento ([fare clic per visualizzare l'immagine con dimensioni normali](paging-and-sorting-report-data-vb/_static/image14.png))
...
**Figura 10**: vengono visualizzati il numero di pagina corrente e del numero totale di pagine ([fare clic per visualizzare l'immagine con dimensioni normali](paging-and-sorting-report-data-vb/_static/image20.png))
...
**Figura 12**: il risultati sono ordinati in base all'elemento UnitPrice in ordine crescente ([fare clic per visualizzare l'immagine con dimensioni normali](paging-and-sorting-report-data-vb/_static/image26.png))
