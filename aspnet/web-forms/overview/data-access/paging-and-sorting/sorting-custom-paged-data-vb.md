...
ms.locfileid: "41828325"
---
<a name="sorting-custom-paged-data-vb"></a>Ordinamento con paging personalizzato dei dati (VB)
====================
...
![Provare diversi valori per le Stored Procedure s tre parametri di Input](sorting-custom-paged-data-vb/_static/image1.png)
...
## <a name="step-2-augmenting-the-data-access-and-business-logic-layers"></a>Passaggio 2: Aumentare l'accesso ai dati e i livelli di logica di Business
...
![Scegliere di usare una Stored Procedure esistente](sorting-custom-paged-data-vb/_static/image5.png)
...
![Usare il GetProductsPagedAndSorted Stored Procedure](sorting-custom-paged-data-vb/_static/image6.png)
...
![Indicare che la Stored Procedure restituisce dati tabulari](sorting-custom-paged-data-vb/_static/image7.png)

**Figura 5**: indica che la Stored Procedure restituisce dati tabulari
...
**Figura 7**: il risultati sono ordinati per il prezzo unitario ([fare clic per visualizzare l'immagine con dimensioni normali](sorting-custom-paged-data-vb/_static/image11.png))
...
![Tentativo di ordinare i risultati in base ai risultati di fornitori la seguente eccezione di Runtime](sorting-custom-paged-data-vb/_static/image12.png)
...
![Modifica SortExpression s SupplierName BoundField su CompanyName](sorting-custom-paged-data-vb/_static/image13.png)

**Figura 9**: modificare SortExpression s SupplierName BoundField in CompanyName
...
**Figura 10**: il risultati ora possono essere ordinate dal fornitore ([fare clic per visualizzare l'immagine con dimensioni normali](sorting-custom-paged-data-vb/_static/image16.png))
...
> [Precedente](efficiently-paging-through-large-amounts-of-data-vb.md)
> [Successivo](creating-a-customized-sorting-user-interface-vb.md)
