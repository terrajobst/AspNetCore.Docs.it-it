...
**Figura 1**: tutti i prodotti sono elencati, ordinati in base `ProductID` ([fare clic per visualizzare l'immagine con dimensioni normali](inserting-updating-and-deleting-data-with-the-sqldatasource-vb/_static/image2.png))
...
**Figura 7**: tramite il `Products` tabella, per restituire il `ProductID`, `ProductName`, `UnitPrice`, e `Discontinued` colonne ([fare clic per visualizzare l'immagine con dimensioni normali](inserting-updating-and-deleting-data-with-the-sqldatasource-vb/_static/image10.png))
...
**Figura 9**: s DetailsView di interfaccia di modifica predefinito ([fare clic per visualizzare l'immagine con dimensioni normali](inserting-updating-and-deleting-data-with-the-sqldatasource-vb/_static/image12.png))
