...
**Figura 2**: copiare Markup dichiarativo di `CheckBoxField.aspx` negli Appunti ([fare clic per visualizzare l'immagine ingrandita](batch-deleting-vb/_static/image4.png))
...
[![L'interfaccia da CheckBoxField.aspx è stato spostato in BatchDeleting.aspx](batch-deleting-vb/_static/image3.gif)](batch-deleting-vb/_static/image5.png)

**Figura 3**: l'interfaccia da `CheckBoxField.aspx` è stato spostato in `BatchDeleting.aspx` ([fare clic per visualizzare l'immagine ingrandita](batch-deleting-vb/_static/image6.png))
...
[![I valori di ProductID eliminati i prodotti sono elencati sotto il controllo GridView.](batch-deleting-vb/_static/image5.gif)](batch-deleting-vb/_static/image9.png)

**Figura 5**: prodotti eliminato il `ProductID` i valori sono elencati sotto il controllo GridView ([fare clic per visualizzare l'immagine ingrandita](batch-deleting-vb/_static/image10.png))
