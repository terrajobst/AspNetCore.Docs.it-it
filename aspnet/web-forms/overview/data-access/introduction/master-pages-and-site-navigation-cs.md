...
**Figura 4**: la pagina Master, quando visualizzati tramite la visualizzazione della struttura ([fare clic per visualizzare l'immagine ingrandita](master-pages-and-site-navigation-cs/_static/image10.png))
...
**Figura 9**: aggiungere una mappa del sito a un progetto ([fare clic per visualizzare l'immagine ingrandita](master-pages-and-site-navigation-cs/_static/image23.png))
...
**Figura 10**: mappa del sito rappresenta una struttura per la navigazione gerarchica ([fare clic per visualizzare l'immagine ingrandita](master-pages-and-site-navigation-cs/_static/image26.png))
...
**Figura 14**: il controllo utente è stato aggiunto alla `Default.aspx` ([fare clic per visualizzare l'immagine ingrandita](master-pages-and-site-navigation-cs/_static/image34.png))


[![Sono elencate le esercitazioni di Reporting base](master-pages-and-site-navigation-cs/_static/image36.png)](master-pages-and-site-navigation-cs/_static/image35.png)

**Figura 15**: sono elencate esercitazioni di Reporting di base ([fare clic per visualizzare l'immagine ingrandita](master-pages-and-site-navigation-cs/_static/image37.png))
