...
**Per creare una definizione di compilazione per elementi di configurazione e distribuzione**
...
Per esaminare lo stato di avanzamento e il risultato di una compilazione&#x2014;indipendentemente dal fatto che è stata attivata automaticamente o manualmente&#x2014;fare doppio clic sulla definizione di compilazione nel **Team Explorer** finestra. Verrà aperta una **Build Explorer** scheda.
