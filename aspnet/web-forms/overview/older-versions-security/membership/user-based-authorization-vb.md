...
[![L'autenticazione basata su form e flusso di lavoro autorizzazione URL](user-based-authorization-vb/_static/image2.png)](user-based-authorization-vb/_static/image1.png)

**Figura 1**: flusso di lavoro autorizzazione URL e l'autenticazione basata su form ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image3.png))
...
[![Il flusso di lavoro predefinita può provocare un ciclo di confusione](user-based-authorization-vb/_static/image5.png)](user-based-authorization-vb/_static/image4.png)

**Figura 2**: il predefinito del flusso di lavoro può causare un ciclo disorienta ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image6.png))
...
**Figura 3**: aggiungere un `Web.config` del File per il `Membership` cartella ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image9.png))
...
[![Poiché l'URL di autorizzazione regole proibire l'accesso anonimo, ci stiamo reindirizzati alla pagina di accesso](user-based-authorization-vb/_static/image14.png)](user-based-authorization-vb/_static/image13.png)

**Figura 5**: poiché l'autorizzazione URL regole non consentire l'accesso anonimo, ci stiamo reindirizzati alla pagina di accesso ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image15.png))
...
**Figura 9**: fare clic su di Delete pulsante non effettivamente Elimina il File ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image27.png))
...
[![Il controllo LoginView solo viene eseguito il rendering FileContents casella di testo per gli utenti autenticati](user-based-authorization-vb/_static/image29.png)](user-based-authorization-vb/_static/image28.png)

**Figura 10**: il LoginView controllo solo viene eseguito il rendering le `FileContents` casella di testo per gli utenti autenticati ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image30.png))
...
**Figura 11**: il controllo LoginView nasconde LinkButton la visualizzazione per i visitatori anonimo ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image33.png))
...
[![Elimina colonna non è sottoposto a rendering quando visitato da un utente diverso da Tito (ad esempio Bruce)](user-based-authorization-vb/_static/image35.png)](user-based-authorization-vb/_static/image34.png)

**Figura 12**: Elimina la colonna non è sottoposto a rendering quando visitato da un utente diverso da Tito (ad esempio Bruce) ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image36.png))
...
**Figura 13**: Elimina la colonna viene eseguito il rendering per Tito ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image39.png))
...
**Figura 14**: se il contesto di sicurezza non è autorizzato a eseguire il metodo, una `SecurityException` viene generata un'eccezione ([fare clic per visualizzare l'immagine ingrandita](user-based-authorization-vb/_static/image42.png))
