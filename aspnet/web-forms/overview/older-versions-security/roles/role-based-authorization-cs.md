...
**Figura 12**: convertire CommandField in un TemplateField ([fare clic per visualizzare l'immagine ingrandita](role-based-authorization-cs/_static/image36.png))
