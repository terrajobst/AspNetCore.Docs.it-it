...
> 
> Vedere questo video per altre informazioni su questo argomento: [usando l'autenticazione di form base in ASP.NET](# "using-basic-forms-authentication-in-aspnet").
...
**Figura 01**: Workflow autenticazione form ([fare clic per visualizzare l'immagine con dimensioni normali](an-overview-of-forms-authentication-vb/_static/image3.png))
...
## <a name="step-4-detecting-authenticated-visitors-and-determining-their-identity"></a>Passaggio 4: Rilevamento dei visitatori autenticati e che determina la propria identità
...
**Figura 11**: viene visualizzato quando si visita in modo anonimo, un collegamento Log ([fare clic per visualizzare l'immagine con dimensioni normali](an-overview-of-forms-authentication-vb/_static/image33.png))
...
Attenuare il ticket di autenticazione come FormsAuthenticationTicket = ident. Ticket
...
**Figura 15**: The LoginView controllo Visualizza Bentornato, Jisun. ([Fare clic per visualizzare l'immagine con dimensioni normali](an-overview-of-forms-authentication-vb/_static/image45.png))
...
**Figura 17**: la pagina di accesso consente di nascondere Markup del predefinito LoginContent ContentPlaceHolder ([fare clic per visualizzare l'immagine con dimensioni normali](an-overview-of-forms-authentication-vb/_static/image51.png))
...
**Figura 19**: Logout Mostra iniziale, estraneo insieme a un controllo LinkButton account di accesso ([fare clic per visualizzare l'immagine con dimensioni normali](an-overview-of-forms-authentication-vb/_static/image57.png))
