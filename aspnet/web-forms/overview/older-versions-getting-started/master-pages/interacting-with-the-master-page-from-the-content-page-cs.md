...
ms.locfileid: "37842876"
---
<a name="interacting-with-the-master-page-from-the-content-page-c"></a>L'interazione con la pagina Master dalla pagina contenuto (c#)
====================
...
**Figura 01**: eseguire l'associazione a un controllo SqlDataSource denominato GridView `RecentProductsDataSource` ([fare clic per visualizzare l'immagine con dimensioni normali](interacting-with-the-master-page-from-the-content-page-cs/_static/image3.png))
...
**Figura 05**: aggiungere una nuova pagina ASP.NET per il `Admin` cartella ([fare clic per visualizzare l'immagine con dimensioni normali](interacting-with-the-master-page-from-the-content-page-cs/_static/image15.png))
...
**Figura 08**: la pagina Master etichetta e GridView viene illustrato il prodotto Just-Added ([fare clic per visualizzare l'immagine con dimensioni normali](interacting-with-the-master-page-from-the-content-page-cs/_static/image24.png))
