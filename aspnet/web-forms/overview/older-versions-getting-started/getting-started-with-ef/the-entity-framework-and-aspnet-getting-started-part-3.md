...
Passare a **Design** consente di visualizzare e selezionare il `EntityDataSource` controllo. Nel **le proprietà** impostare nella finestra di `Where` proprietà `it.EnrollmentDate is not null`.
