...
| **Tag** | **Descrizione** |
| --- | --- |
| &lt;Elemento ContentTemplate&gt; | Specifica il markup da utilizzare per eseguire il rendering di risultato del rendering parziale. Elemento figlio &lt;asp: UpdatePanel&gt;. |
