...
[![Utilizzare un Client FTP per copiare i file necessari dal Desktop nel server Web a Provider di hosting Web.](deploying-your-site-using-an-ftp-client-vb/_static/image2.png)](deploying-your-site-using-an-ftp-client-vb/_static/image1.png)
...
**Figura 2**: il sito revisioni del libro è ora accessibile a chiunque disponga di una connessione Internet ([fare clic per visualizzare l'immagine ingrandita](deploying-your-site-using-an-ftp-client-vb/_static/image6.png))
...
[![Utilizzare un Client FTP per copiare i file necessari dal Desktop nel server Web a Provider di hosting Web](deploying-your-site-using-an-ftp-client-vb/_static/image8.png)](deploying-your-site-using-an-ftp-client-vb/_static/image7.png)

**Figura 3**: usare un FTP Client per copiare i file necessari da Your Desktop nel server Web a Provider di hosting Web ([fare clic per visualizzare l'immagine ingrandita](deploying-your-site-using-an-ftp-client-vb/_static/image9.png))
