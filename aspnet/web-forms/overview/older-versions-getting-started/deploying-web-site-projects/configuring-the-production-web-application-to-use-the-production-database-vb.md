...
**Figura 3**: The Data-Driven applicazione è ora disponibile in produzione. ([Fare clic per visualizzare l'immagine con dimensioni normali](configuring-the-production-web-application-to-use-the-production-database-vb/_static/image9.jpg))
