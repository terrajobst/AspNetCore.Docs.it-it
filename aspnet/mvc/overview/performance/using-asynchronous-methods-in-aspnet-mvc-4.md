...
- *Mvc4Async*: progetto di ASP.NET MVC 4 che contiene il codice usato in questa esercitazione. Effettua chiamate all'API Web per il **WebAPIpgw** servizio.
