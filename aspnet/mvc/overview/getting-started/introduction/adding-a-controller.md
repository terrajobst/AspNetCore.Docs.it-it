...
> [!NOTE]
> Nota sulla sicurezza: Il codice precedente viene [HttpUtility](https://msdn.microsoft.com/en-us/library/ee360286(v=vs.110).aspx) per proteggere l'applicazione da input dannosi (vale a dire JavaScript). Per ulteriori informazioni vedere [procedura: proteggere dagli attacchi tramite Script in un'applicazione Web da applicare la codifica HTML alle stringhe](https://msdn.microsoft.com/en-us/library/a2a4yykt(v=vs.100).aspx).
