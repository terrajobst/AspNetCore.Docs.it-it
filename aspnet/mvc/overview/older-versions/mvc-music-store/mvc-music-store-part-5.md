...
Nota: Viene illustrato il caso di creazione e utilizzo di un helper in una visualizzazione semplice. Per ulteriori informazioni sulla creazione di helper che è possibile utilizzare in tutto il sito, vedere il post di blog: [http://bit.ly/mvc3-helper-options](http://bit.ly/mvc3-helper-options)
