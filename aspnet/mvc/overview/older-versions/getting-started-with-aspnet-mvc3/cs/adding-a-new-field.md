...
Aggiungere due utilizzando le istruzioni nella parte superiore del file. Il primo fa riferimento lo spazio dei nomi di Entity Framework e il secondo fa riferimento lo spazio dei nomi in cui il nostro `MovieInitializer` classe vita:

[!code-csharp[Main](adding-a-new-field/samples/sample6.cs)]

Individuare il `Application_Start` (metodo) e aggiungere una chiamata a `Database.SetInitializer` all'inizio del metodo, come illustrato di seguito:
