...
Esempi di query supporti: &gt;  <strong>@media tutte e (larghezza massima: 1000px) e (min-width: 700px) {}:</strong> per tutte le risoluzioni tra 700px e 1000px.

> <strong>@media schermata e (min-width: 400px) e (larghezza massima: 700px) {…}:</strong> solo per le schermate. La risoluzione deve essere compreso tra 400 e 700px.
> 
> <strong>@media palmari e (min-width: 20em), schermo e (min-width: 20em) {…}:</strong> per palmari (mobili e dispositivi) e schermate iniziali. La larghezza minima deve essere maggiore di 20em.
> 
...
3. Aprire <strong>Site.css</strong> file da Esplora soluzioni di Visual Studio, si trova <strong>contenuto</strong> cartella del progetto. Premere <strong>CTRL + F</strong> aprire ricerca integrata in Visual Studio e scrivere <strong>@media</strong> per individuare il <strong>query supporti CSS</strong>.
...
4. Sostituire il valore dell'attributo larghezza massima impostato in 850 px con **10px**, per disabilitare il rendering e premere **CTRL + S** per salvare le modifiche. Tornare al browser e premere **CTRL + F5** per aggiornare la pagina con le modifiche apportate. Notare le differenze in entrambe le tabelle quando si modifica la larghezza della finestra.
    ...
    <em>Nella parte sinistra, applica la pagina di @media stile, lo stile di destra viene omesso</em>
...
2. Aprire il nuovo creata **Index.Mobile.cshtml** consente di visualizzare e sostituire &lt;ul&gt; tag con questo codice. In questo modo, si aggiornano i &lt;ul&gt; tag con le annotazioni dei dati per dispositivi mobili jQuery per usare i temi di jQuery mobili.
    ...
    > 
    > Altre informazioni sulle convenzioni per dispositivi mobili jQuery nella documentazione del progetto: [[http://jquerymobile.com/demos/1.1.1/](http://jquerymobile.com/demos/1.1.1/)](http://jquerymobile.com/demos/1.1.1/)
...
7. Passare nuovamente alla visualizzazione dei dispositivi mobili e passare a <strong>sulle</strong> pagina (http://localhost[porta] / Home/su). Si noti che, anche se è stata creata una vista About.Mobile.cshtml, informazioni su verrà visualizzata la pagina utilizzando il layout di dispositivi mobili (\_Layout.Mobile.cshtml).
...
1. Passare a [ [ https://go.microsoft.com/?linkid=9809776 ](https://go.microsoft.com/?linkid=9809776) ](https://go.microsoft.com/?linkid=9810169). In alternativa, se è già stato installato installazione guidata piattaforma Web, è possibile aprire e ricerca per il prodotto &quot; <em>WebMatrix 2</em>&quot;.
2. Fare clic su **installa**. Se non si dispone **installazione guidata piattaforma Web** si verrà reindirizzati per scaricarlo e installarlo prima.
3. Una volta **installazione guidata piattaforma Web** è aperto, fare clic su **installare** per avviare l'installazione.
