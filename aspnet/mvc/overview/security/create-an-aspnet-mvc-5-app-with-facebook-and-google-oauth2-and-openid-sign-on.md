...
<span data-ttu-id="c6d12-252">Nel **vista** menu, fare clic su **Esplora Server**.</span><span class="sxs-lookup"><span data-stu-id="c6d12-252">In the **View** menu, click **Server Explorer**.</span></span>
