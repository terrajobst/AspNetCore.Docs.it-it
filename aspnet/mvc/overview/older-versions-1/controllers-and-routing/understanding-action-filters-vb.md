...
ms.locfileid: "41827508"
---
<a name="understanding-action-filters-vb"></a>Informazioni sui filtri azione (VB)
====================
...
**Figura 01**: memorizzate nella cache ([fare clic per visualizzare l'immagine con dimensioni normali](understanding-action-filters-vb/_static/image3.png))
