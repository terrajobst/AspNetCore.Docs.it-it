...
**Elenco di 3 - Controllers\ContactController.vb (metodo di indice)**
...
[![La pagina di conferma eliminazione](iteration-7-add-ajax-functionality-vb/_static/image2.jpg)](iteration-7-add-ajax-functionality-vb/_static/image3.png)

**Figura 02**: la pagina di conferma eliminazione ([fare clic per visualizzare l'immagine ingrandita](iteration-7-add-ajax-functionality-vb/_static/image4.png))
...
**Elenco 7 - Controllers\ContactController.vb (AjaxDelete)**   
