...
**Figura 01**: un form con la convalida ([fare clic per visualizzare l'immagine ingrandita](iteration-3-add-form-validation-vb/_static/image2.png))
...
**Elenco di 2 - Controllers\ContactController.vb (Create con la convalida)**
