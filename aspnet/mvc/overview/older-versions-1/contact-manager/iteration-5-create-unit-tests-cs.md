...
**Figura 02**: i riferimenti dopo l'aggiunta di Moq ([fare clic per visualizzare l'immagine con dimensioni normali](iteration-5-create-unit-tests-cs/_static/image4.png))
...
**Figura 04**: i risultati del Test ([fare clic per visualizzare l'immagine con dimensioni normali](iteration-5-create-unit-tests-cs/_static/image8.png))
