...
**Figura 02**: la visualizzazione in anteprima una pagina master nella finestra di progettazione ([fare clic per visualizzare l'immagine con dimensioni normali](creating-page-layouts-with-view-master-pages-cs/_static/image6.png))
...
**Figura 04**: la selezione di una pagina master ([fare clic per visualizzare l'immagine con dimensioni normali](creating-page-layouts-with-view-master-pages-cs/_static/image12.png))
...
**Figura 05**: pagina contenuto visualizzazione l'indice ([fare clic per visualizzare l'immagine con dimensioni normali](creating-page-layouts-with-view-master-pages-cs/_static/image15.png))
