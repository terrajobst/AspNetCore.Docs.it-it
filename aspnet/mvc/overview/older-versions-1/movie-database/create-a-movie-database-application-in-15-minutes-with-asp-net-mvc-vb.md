...
ms.locfileid: "37831200"
---
<a name="create-a-movie-database-application-in-15-minutes-with-aspnet-mvc-vb"></a>Creare un'applicazione di Database di film in 15 minuti con ASP.NET MVC (VB)
====================
...
Iniziamo creando un nuovo progetto di applicazione Web ASP.NET MVC in Visual Studio 2008. Selezionare l'opzione di menu **File, nuovo progetto** si noterà la finestra di dialogo Nuovo progetto nella figura 1. Selezionare Visual Basic come linguaggio di programmazione e selezionare il modello di progetto applicazione Web ASP.NET MVC. Assegnare al progetto il nome MovieApp e fare clic sul pulsante OK.
...
**Figura 01**: finestra di dialogo Nuovo progetto di ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image2.png))
...
**Figura 02**: finestra di dialogo di creazione progetto Unit Test ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image4.png))
...
**Figura 03**: la creazione di un Database Microsoft SQL Server ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image6.png))
...
**Figura 04**: tabella di database di film ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image8.png))
...
**Figura 05**: immettere i record di film ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image10.png))
...
**Figura 06**: generazione di un modello di database con la procedura guidata Entity Data Model ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image12.png))
...
**Figura 07**: The Entity Data Model Designer ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image14.png))
...
**Figura 08**: aggiunge un nuovo Controller MVC ASP.NET ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image16.png))
...
**Listato 2 – Controllers/HomeController.vb (metodo indice modificato)**
...
4. Dal **visualizzare i dati classe** elenco a discesa selezionare il valore *MovieApp.Movie*.
...
**Figura 09**: aggiunta di una vista da un'azione del controller ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image18.png))
...
**Figura 10**: creazione di una nuova vista con la finestra di dialogo Aggiungi visualizzazione ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image20.png))
...
**Figura 11**: Visualizza l'indice ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image22.png))
...
**Figura 12**: aggiunta della visualizzazione di creazione ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image24.png))
...
**Figura 13**: la creazione di un nuovo record di database di film ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image26.png))
...
In primo luogo, è necessario generare il modulo di modifica. Questo passaggio è semplice perché Visual Studio genera il modulo di modifica per noi automaticamente. Aprire la classe HomeController.vb nell'editor di codice di Visual Studio e seguire questa procedura:
...
**Figura 14**: aggiunta della visualizzazione di modifica ([fare clic per visualizzare l'immagine con dimensioni normali](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image28.png))
...
**Listato 6 – Controllers\HomeController.vb (metodi Edit)**
