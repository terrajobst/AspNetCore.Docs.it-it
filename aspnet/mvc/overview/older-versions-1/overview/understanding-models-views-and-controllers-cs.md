...
**Figura 02**: creare Unit Test finestra ([fare clic per visualizzare l'immagine con dimensioni normali](understanding-models-views-and-controllers-cs/_static/image4.png))
...
**Figura 04**: finestra di dialogo Debug non abilitato ([fare clic per visualizzare l'immagine con dimensioni normali](understanding-models-views-and-controllers-cs/_static/image8.png))
...
Un controller è semplicemente una classe (ad esempio, una classe Visual Basic o c#). L'esempio di applicazione MVC ASP.NET include un controller denominato HomeController.cs che si trova nella cartella controller. Il contenuto del file HomeController.cs viene riprodotto nel listato 2.
