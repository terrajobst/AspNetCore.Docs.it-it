...
I video illustra l'utilizzo di controllo pagina in applicazioni web ASP.NET MVC. [Guarda l'esercitazione](../../overview/views/using-page-inspector-in-aspnet-mvc.md)
