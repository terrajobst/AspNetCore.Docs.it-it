...
ms.locfileid: "30070651"
---
<a name="aspnet-web-forms-and-ajax-451"></a><span data-ttu-id="c12a3-102">Web Form ASP.NET e Ajax 4.5.1</span><span class="sxs-lookup"><span data-stu-id="c12a3-102">ASP.NET Web Forms and Ajax 4.5.1</span></span>
====================
<span data-ttu-id="c12a3-103">I file seguenti sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="c12a3-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="c12a3-104">Nota: È possono trovare gli script di globalizzazione, ad esempio FR.js-fr, nella cartella seguente:</span><span class="sxs-lookup"><span data-stu-id="c12a3-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
