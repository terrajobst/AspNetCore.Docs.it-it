...
ms.locfileid: "30070875"
---
<a name="jqueryvalidate-version-19"></a><span data-ttu-id="c4ea5-102">versione jQuery.Validate 1.9</span><span class="sxs-lookup"><span data-stu-id="c4ea5-102">jquery.validate version 1.9</span></span>
====================
<span data-ttu-id="c4ea5-103">I file seguenti sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="c4ea5-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="c4ea5-104">File localizzazione https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages \_. js # # dove # # è il codice loc.</span><span class="sxs-lookup"><span data-stu-id="c4ea5-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
