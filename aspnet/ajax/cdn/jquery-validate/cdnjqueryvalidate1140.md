...
---
<a name="jquery-validation-1140"></a><span data-ttu-id="f1ea6-102">Convalida di jQuery 1.14.0</span><span class="sxs-lookup"><span data-stu-id="f1ea6-102">jQuery Validation 1.14.0</span></span>
====================
<span data-ttu-id="f1ea6-103">Sulla rete CDN sono ospitati i file seguenti:</span><span class="sxs-lookup"><span data-stu-id="f1ea6-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="f1ea6-104">File di localizzazione al https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js dove # # è il codice di localizzazione.</span><span class="sxs-lookup"><span data-stu-id="f1ea6-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js where ## is the loc code.</span></span>
