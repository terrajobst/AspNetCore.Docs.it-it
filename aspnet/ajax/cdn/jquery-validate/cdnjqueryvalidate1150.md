...
ms.locfileid: "30070784"
---
<a name="jquery-validation-1150"></a><span data-ttu-id="e5ffa-102">Convalida 1.15.0 jQuery</span><span class="sxs-lookup"><span data-stu-id="e5ffa-102">jQuery Validation 1.15.0</span></span>
====================
<span data-ttu-id="e5ffa-103">I file seguenti sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="e5ffa-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="e5ffa-104">File localizzazione https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages \_. js # # dove # # è il codice loc.</span><span class="sxs-lookup"><span data-stu-id="e5ffa-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
