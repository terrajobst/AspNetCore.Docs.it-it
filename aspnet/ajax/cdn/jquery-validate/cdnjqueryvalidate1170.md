...
ms.locfileid: "41831578"
---
<a name="jquery-validation-1170"></a><span data-ttu-id="0fb8a-102">jQuery Validation 1.17.0</span><span class="sxs-lookup"><span data-stu-id="0fb8a-102">jQuery Validation 1.17.0</span></span>
====================
<span data-ttu-id="0fb8a-103">Sulla rete CDN sono ospitati i file seguenti:</span><span class="sxs-lookup"><span data-stu-id="0fb8a-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="0fb8a-104">File di localizzazione al https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js dove # # è il codice di localizzazione.</span><span class="sxs-lookup"><span data-stu-id="0fb8a-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.17.0/localization/messages\_##.js where ## is the loc code.</span></span>
