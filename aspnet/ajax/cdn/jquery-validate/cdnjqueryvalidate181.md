...
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="9ba03-102">jQuery. Validate versione 1.8.1</span><span class="sxs-lookup"><span data-stu-id="9ba03-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="9ba03-103">Sulla rete CDN sono ospitati i file seguenti:</span><span class="sxs-lookup"><span data-stu-id="9ba03-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="9ba03-104">File di localizzazione al https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js dove # # è il codice di localizzazione.</span><span class="sxs-lookup"><span data-stu-id="9ba03-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
