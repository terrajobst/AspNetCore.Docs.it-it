...
---
<a name="jquery-validation-1160"></a><span data-ttu-id="bd3b0-102">Convalida di jQuery 1.16.0</span><span class="sxs-lookup"><span data-stu-id="bd3b0-102">jQuery Validation 1.16.0</span></span>
====================
<span data-ttu-id="bd3b0-103">Sulla rete CDN sono ospitati i file seguenti:</span><span class="sxs-lookup"><span data-stu-id="bd3b0-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="bd3b0-104">File di localizzazione al https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js dove # # è il codice di localizzazione.</span><span class="sxs-lookup"><span data-stu-id="bd3b0-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js where ## is the loc code.</span></span>
