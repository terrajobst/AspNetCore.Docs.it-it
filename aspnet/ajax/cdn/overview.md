...
<span data-ttu-id="5c97f-112">**[Utilizzo di jQuery UI dalla rete CDN](#Using_jQuery_UI_from_the_CDN_22)**</span><span class="sxs-lookup"><span data-stu-id="5c97f-112">**[Using jQuery UI from the CDN](#Using_jQuery_UI_from_the_CDN_22)**</span></span>  
...
#### <a name="jquery-version-320"></a><span data-ttu-id="5c97f-203">versione di jQuery 3.2.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-203">jQuery version 3.2.0</span></span>
...
#### <a name="jquery-version-162"></a><span data-ttu-id="5c97f-244">versione di jQuery 1.6.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-244">jQuery version 1.6.2</span></span>
...
#### <a name="jquery-version-144"></a><span data-ttu-id="5c97f-250">versione di jQuery 1.4.4</span><span class="sxs-lookup"><span data-stu-id="5c97f-250">jQuery version 1.4.4</span></span>
...
- [<span data-ttu-id="5c97f-283">jQuery UI 1.8.23</span><span class="sxs-lookup"><span data-stu-id="5c97f-283">jQuery UI 1.8.23</span></span>](jquery-ui/cdnjqueryui1823.md "jQuery UI 1.8.23 sulla rete CDN di Microsoft Ajax")
...
- [<span data-ttu-id="5c97f-321">jQuery Validate 1.5.5</span><span class="sxs-lookup"><span data-stu-id="5c97f-321">jQuery Validate 1.5.5</span></span>](jquery-validate/cdnjqueryvalidate155.md "jQuery Validate 1.5.5")
...
- [<span data-ttu-id="5c97f-341">la versione beta di jQuery Mobile 1.0 3</span><span class="sxs-lookup"><span data-stu-id="5c97f-341">jQuery Mobile 1.0 beta 3</span></span>](jquery-mobile/cdnjquerymobile10b3.md "jQuery Mobile 1.0 Beta 3 nella rete CDN di Microsoft Ajax")
...
- [<span data-ttu-id="5c97f-355">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="5c97f-355">jQuery DataTables 1.10.5</span></span>](jquery-datatables/cdnjquerydatatables105.md "jQuery DataTables 1.10.5")
...
#### <a name="globalize-version-011"></a><span data-ttu-id="5c97f-372">Globalizzazione versione 0.1.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-372">Globalize version 0.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.min.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/globalize.js
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.cultures.js

    - <span data-ttu-id="5c97f-373">tutte le impostazioni cultura</span><span class="sxs-lookup"><span data-stu-id="5c97f-373">all cultures</span></span>
- https://ajax.aspnetcdn.com/ajax/globalize/0.1.1/cultures/globalize.culture.{culture-code}.js

    - <span data-ttu-id="5c97f-374">Sostituire "{codice delle impostazioni cultura}" con il codice della lingua desiderata, ad esempio, dei file in rete CDN di Microsoft globalize.culture.en GB.js== = = queste librerie sono state caricate da Microsoft.</span><span class="sxs-lookup"><span data-stu-id="5c97f-374">Replace "{culture-code}" with the desired culture code, e.g. globalize.culture.en-GB.js== Microsoft Files on the CDN ==These libraries were uploaded by Microsoft.</span></span>

<a id="Respond_Releases_on_the_CDN_13"></a>

### <a name="respond-releases-on-the-cdn"></a><span data-ttu-id="5c97f-375">Rispondere versioni su una rete CDN</span><span class="sxs-lookup"><span data-stu-id="5c97f-375">Respond Releases on the CDN</span></span>

<span data-ttu-id="5c97f-376">Le seguenti versioni di [ https://github.com/scottjehl/Respond ] (https://github.com/scottjehl/Respond " https://github.com/scottjehl/Respond ") rispondono ospitate nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="5c97f-376">The following releases of [https://github.com/scottjehl/Respond](https://github.com/scottjehl/Respond "https://github.com/scottjehl/Respond") Respond are hosted on the CDN:</span></span>

#### <a name="respond-version-142"></a><span data-ttu-id="5c97f-377">Rispondere versione 1.4.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-377">Respond version 1.4.2</span></span>
...
#### <a name="respond-version-141"></a><span data-ttu-id="5c97f-378">Rispondere versione 1.4.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-378">Respond version 1.4.1</span></span>
...
#### <a name="respond-version-140"></a><span data-ttu-id="5c97f-379">Rispondere versione 1.4.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-379">Respond version 1.4.0</span></span>
...
#### <a name="respond-version-130"></a><span data-ttu-id="5c97f-380">Rispondere versione 1.3.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-380">Respond version 1.3.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.3.0/respond.js

#### <a name="respond-version-120"></a><span data-ttu-id="5c97f-381">Rispondere versione 1.2.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-381">Respond version 1.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/respond/1.2.0/respond.js

<a id="Bootstrap_Releases_on_the_CDN_14"></a>

### <a name="bootstrap-releases-on-the-cdn"></a><span data-ttu-id="5c97f-382">Versioni di bootstrap nella rete CDN</span><span class="sxs-lookup"><span data-stu-id="5c97f-382">Bootstrap Releases on the CDN</span></span>

<span data-ttu-id="5c97f-383">Le seguenti versioni di [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap ospitate nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="5c97f-383">The following releases of [getbootstrap.com](http://getbootstrap.com "getbootstrap.com") bootstrap are hosted on the CDN:</span></span>

#### <a name="bootstrap-version-400"></a><span data-ttu-id="5c97f-384">Versione bootstrap 4.0.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-384">Bootstrap version 4.0.0</span></span>
...
#### <a name="bootstrap-version-337"></a><span data-ttu-id="5c97f-385">Versione bootstrap 3.3.7</span><span class="sxs-lookup"><span data-stu-id="5c97f-385">Bootstrap version 3.3.7</span></span>
...
#### <a name="bootstrap-version-336"></a><span data-ttu-id="5c97f-386">Versione bootstrap 3.3.6</span><span class="sxs-lookup"><span data-stu-id="5c97f-386">Bootstrap version 3.3.6</span></span>
...
#### <a name="bootstrap-version-335"></a><span data-ttu-id="5c97f-387">Bootstrap versione 3.3.5</span><span class="sxs-lookup"><span data-stu-id="5c97f-387">Bootstrap version 3.3.5</span></span>
...
#### <a name="bootstrap-version-334"></a><span data-ttu-id="5c97f-388">Versione bootstrap 3.3.4</span><span class="sxs-lookup"><span data-stu-id="5c97f-388">Bootstrap version 3.3.4</span></span>
...
#### <a name="bootstrap-version-332"></a><span data-ttu-id="5c97f-389">Versione bootstrap 3.3.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-389">Bootstrap version 3.3.2</span></span>
...
#### <a name="bootstrap-version-331"></a><span data-ttu-id="5c97f-390">Versione bootstrap 3.3.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-390">Bootstrap version 3.3.1</span></span>
...
#### <a name="bootstrap-version-330"></a><span data-ttu-id="5c97f-391">Versione bootstrap 3.3.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-391">Bootstrap version 3.3.0</span></span>
...
#### <a name="bootstrap-version-320"></a><span data-ttu-id="5c97f-392">Versione bootstrap 3.2.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-392">Bootstrap version 3.2.0</span></span>
...
#### <a name="bootstrap-version-311"></a><span data-ttu-id="5c97f-393">Versione bootstrap 3.1.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-393">Bootstrap version 3.1.1</span></span>
...
#### <a name="bootstrap-version-310"></a><span data-ttu-id="5c97f-394">Bootstrap versione 3.1.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-394">Bootstrap version 3.1.0</span></span>
...
#### <a name="bootstrap-version-303"></a><span data-ttu-id="5c97f-395">Versione bootstrap 3.0.3</span><span class="sxs-lookup"><span data-stu-id="5c97f-395">Bootstrap version 3.0.3</span></span>
...
#### <a name="bootstrap-version-302"></a><span data-ttu-id="5c97f-396">Versione bootstrap 3.0.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-396">Bootstrap version 3.0.2</span></span>
...
#### <a name="bootstrap-version-301"></a><span data-ttu-id="5c97f-397">Versione bootstrap 3.0.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-397">Bootstrap version 3.0.1</span></span>
...
#### <a name="bootstrap-version-300"></a><span data-ttu-id="5c97f-398">Versione bootstrap 3.0.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-398">Bootstrap version 3.0.0</span></span>
...
#### <a name="bootstrap-version-232"></a><span data-ttu-id="5c97f-399">Bootstrap versione 2.3.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-399">Bootstrap version 2.3.2</span></span>
...
#### <a name="bootstrap-version-231"></a><span data-ttu-id="5c97f-400">Bootstrap versione 2.3.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-400">Bootstrap version 2.3.1</span></span>
...
### <a name="bootstrap-touchcarousel-releases-on-the-cdn"></a><span data-ttu-id="5c97f-401">Versioni di bootstrap TouchCarousel nella rete CDN</span><span class="sxs-lookup"><span data-stu-id="5c97f-401">Bootstrap TouchCarousel Releases on the CDN</span></span>

<span data-ttu-id="5c97f-402">Le seguenti versioni di [ https://github.com/ixisio/bootstrap-touch-carousel ] (https://github.com/ixisio/bootstrap-touch-carousel " https://github.com/ixisio/bootstrap-touch-carousel ") TouchCarousel Bootstrap versioni sono ospitate nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="5c97f-402">The following releases of [https://github.com/ixisio/bootstrap-touch-carousel](https://github.com/ixisio/bootstrap-touch-carousel "https://github.com/ixisio/bootstrap-touch-carousel") Bootstrap TouchCarousel releases are hosted on the CDN:</span></span>

#### <a name="bootstrap-touchcarousel-version-080"></a><span data-ttu-id="5c97f-403">Bootstrap TouchCarousel version 0.8.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-403">Bootstrap TouchCarousel version 0.8.0</span></span>
...
### <a name="hammerjs-releases-on-the-cdn"></a><span data-ttu-id="5c97f-404">Versioni di Hammer.js nella rete CDN</span><span class="sxs-lookup"><span data-stu-id="5c97f-404">Hammer.js Releases on the CDN</span></span>

<span data-ttu-id="5c97f-405">Le seguenti versioni di [ http://hammerjs.github.io/ ] (http://hammerjs.github.io/ " http://hammerjs.github.io/ ") Hammer.js versioni ospitate nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="5c97f-405">The following releases of [http://hammerjs.github.io/](http://hammerjs.github.io/ "http://hammerjs.github.io/") Hammer.js releases are hosted on the CDN:</span></span>

#### <a name="hammerjs-version-204"></a><span data-ttu-id="5c97f-406">Versione Hammer.js 2.0.4</span><span class="sxs-lookup"><span data-stu-id="5c97f-406">Hammer.js version 2.0.4</span></span>
...
### <a name="aspnet-web-forms-and-ajax-releases-on-the-cdn"></a><span data-ttu-id="5c97f-407">Web Form ASP.NET e Ajax versioni nella rete CDN</span><span class="sxs-lookup"><span data-stu-id="5c97f-407">ASP.NET Web Forms and Ajax Releases on the CDN</span></span>

<span data-ttu-id="5c97f-408">Le seguenti versioni di ASP.NET Ajax Library sono ospitate nella rete CDN.</span><span class="sxs-lookup"><span data-stu-id="5c97f-408">The following releases of the ASP.NET Ajax Library are hosted on the CDN.</span></span> <span data-ttu-id="5c97f-409">Fare clic su ogni collegamento per visualizzare l'elenco effettivo dei file.</span><span class="sxs-lookup"><span data-stu-id="5c97f-409">Click each link to see the actual list of files.</span></span>

- [<span data-ttu-id="5c97f-410">Web Form ASP.NET e Ajax versione 4.5.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-410">ASP.NET Web Forms and Ajax version 4.5.2</span></span>](cdnajax452.md "Web Form ASP.NET e Ajax 4.5.2")
- [<span data-ttu-id="5c97f-411">Web Form ASP.NET e Ajax versione 4</span><span class="sxs-lookup"><span data-stu-id="5c97f-411">ASP.NET Web Forms and Ajax version 4</span></span>](cdnajax4.md "Web Form ASP.NET e Ajax 4")
- [<span data-ttu-id="5c97f-412">ASP.NET Ajax versione 3.5</span><span class="sxs-lookup"><span data-stu-id="5c97f-412">ASP.NET Ajax version 3.5</span></span>](cdnajax35.md "Ajax ASP.NET 3.5")

<a id="ASPNET_MVC_Releases_on_the_CDN_16"></a>

### <a name="aspnet-mvc-releases-on-the-cdn"></a><span data-ttu-id="5c97f-413">ASP.NET MVC rilascia nella rete CDN</span><span class="sxs-lookup"><span data-stu-id="5c97f-413">ASP.NET MVC Releases on the CDN</span></span>

<span data-ttu-id="5c97f-414">I seguenti file JavaScript di ASP.NET MVC sono ospitati in questa rete CDN:</span><span class="sxs-lookup"><span data-stu-id="5c97f-414">The following ASP.NET MVC JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-mvc-523"></a><span data-ttu-id="5c97f-415">ASP.NET MVC 5.2.3</span><span class="sxs-lookup"><span data-stu-id="5c97f-415">ASP.NET MVC 5.2.3</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.2.3/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-51"></a><span data-ttu-id="5c97f-416">ASP.NET MVC 5.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-416">ASP.NET MVC 5.1</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.1/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-50"></a><span data-ttu-id="5c97f-417">ASP.NET MVC 5.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-417">ASP.NET MVC 5.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/5.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-40"></a><span data-ttu-id="5c97f-418">ASP.NET MVC 4.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-418">ASP.NET MVC 4.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.js
- https://ajax.aspnetcdn.com/ajax/mvc/4.0/jquery.validate.unobtrusive.min.js

#### <a name="aspnet-mvc-30"></a><span data-ttu-id="5c97f-419">ASP.NET MVC 3.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-419">ASP.NET MVC 3.0</span></span>
...
#### <a name="aspnet-mvc-20"></a><span data-ttu-id="5c97f-420">ASP.NET MVC 2.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-420">ASP.NET MVC 2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.js
- https://ajax.aspnetcdn.com/ajax/mvc/2.0/MicrosoftMvcAjax.debug.js

#### <a name="aspnet-mvc-10"></a><span data-ttu-id="5c97f-421">ASP.NET MVC 1.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-421">ASP.NET MVC 1.0</span></span>
...
### <a name="aspnet-signalr-releases-on-the-cdn"></a><span data-ttu-id="5c97f-422">ASP.NET SignalR rilascia nella rete CDN</span><span class="sxs-lookup"><span data-stu-id="5c97f-422">ASP.NET SignalR Releases on the CDN</span></span>

<span data-ttu-id="5c97f-423">I seguenti file di ASP.NET SignalR JavaScript sono ospitati in questa rete CDN:</span><span class="sxs-lookup"><span data-stu-id="5c97f-423">The following ASP.NET SignalR JavaScript files are hosted on this CDN:</span></span>

#### <a name="aspnet-signalr-222"></a><span data-ttu-id="5c97f-424">ASP.NET SignalR 2.2.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-424">ASP.NET SignalR 2.2.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.2.js

#### <a name="aspnet-signalr-221"></a><span data-ttu-id="5c97f-425">ASP.NET SignalR 2.2.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-425">ASP.NET SignalR 2.2.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.1.js

#### <a name="aspnet-signalr-220"></a><span data-ttu-id="5c97f-426">ASP.NET SignalR 2.2.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-426">ASP.NET SignalR 2.2.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.2.0.js

#### <a name="aspnet-signalr-210"></a><span data-ttu-id="5c97f-427">ASP.NET SignalR 2.1.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-427">ASP.NET SignalR 2.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.1.0.js

#### <a name="aspnet-signalr-203"></a><span data-ttu-id="5c97f-428">ASP.NET SignalR 2.0.3</span><span class="sxs-lookup"><span data-stu-id="5c97f-428">ASP.NET SignalR 2.0.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.3.js

#### <a name="aspnet-signalr-202"></a><span data-ttu-id="5c97f-429">ASP.NET SignalR 2.0.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-429">ASP.NET SignalR 2.0.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.2.js

#### <a name="aspnet-signalr-201"></a><span data-ttu-id="5c97f-430">ASP.NET SignalR 2.0.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-430">ASP.NET SignalR 2.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.1.js

#### <a name="aspnet-signalr-200"></a><span data-ttu-id="5c97f-431">ASP.NET SignalR 2.0.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-431">ASP.NET SignalR 2.0.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-2.0.0.js

#### <a name="aspnet-signalr-113"></a><span data-ttu-id="5c97f-432">ASP.NET SignalR 1.1.3</span><span class="sxs-lookup"><span data-stu-id="5c97f-432">ASP.NET SignalR 1.1.3</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.3.js

#### <a name="aspnet-signalr-112"></a><span data-ttu-id="5c97f-433">ASP.NET SignalR 1.1.2</span><span class="sxs-lookup"><span data-stu-id="5c97f-433">ASP.NET SignalR 1.1.2</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.2.js

#### <a name="aspnet-signalr-111"></a><span data-ttu-id="5c97f-434">ASP.NET SignalR 1.1.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-434">ASP.NET SignalR 1.1.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.1.js

#### <a name="aspnet-signalr-110"></a><span data-ttu-id="5c97f-435">ASP.NET SignalR 1.1.0</span><span class="sxs-lookup"><span data-stu-id="5c97f-435">ASP.NET SignalR 1.1.0</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.1.0.js

#### <a name="aspnet-signalr-101"></a><span data-ttu-id="5c97f-436">ASP.NET SignalR 1.0.1</span><span class="sxs-lookup"><span data-stu-id="5c97f-436">ASP.NET SignalR 1.0.1</span></span>

- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.min.js
- https://ajax.aspnetcdn.com/ajax/signalr/jquery.signalr-1.0.1.js

<span data-ttu-id="5c97f-437">Per informazioni sulle condizioni di utilizzo per la rete CDN, vedere [Microsoft Ajax CDN condizioni di utilizzo](https://www.asp.net/terms-of-use "Microsoft Ajax CDN condizioni di utilizzo").</span><span class="sxs-lookup"><span data-stu-id="5c97f-437">For information about the terms of use for the CDN, see [Microsoft Ajax CDN Terms of Use](https://www.asp.net/terms-of-use "Microsoft Ajax CDN Terms of Use").</span></span>
