...
ms.locfileid: "37365899"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="4cbc8-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="4cbc8-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="4cbc8-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="4cbc8-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
