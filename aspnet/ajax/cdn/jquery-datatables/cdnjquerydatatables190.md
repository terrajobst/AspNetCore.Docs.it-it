...
ms.locfileid: "37821883"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="428e5-102">jQuery 1.9.0 DataTables</span><span class="sxs-lookup"><span data-stu-id="428e5-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="428e5-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="428e5-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
