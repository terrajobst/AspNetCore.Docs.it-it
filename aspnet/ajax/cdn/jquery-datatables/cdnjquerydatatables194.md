...
ms.locfileid: "37822940"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="12f30-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="12f30-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="12f30-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="12f30-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
