...
ms.locfileid: "37365188"
---
<a name="jquery-datatables-193"></a><span data-ttu-id="7e469-102">jQuery DataTables 1.9.3</span><span class="sxs-lookup"><span data-stu-id="7e469-102">jQuery DataTables 1.9.3</span></span>
====================
<span data-ttu-id="7e469-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="7e469-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
