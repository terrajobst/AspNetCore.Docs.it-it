...
ms.locfileid: "41827274"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="ac28e-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="ac28e-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="ac28e-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="ac28e-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
