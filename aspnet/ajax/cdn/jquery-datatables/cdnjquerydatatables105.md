...
ms.locfileid: "37818178"
---
<a name="jquery-datatables-1105"></a><span data-ttu-id="c2539-102">jQuery DataTables 1.10.5</span><span class="sxs-lookup"><span data-stu-id="c2539-102">jQuery DataTables 1.10.5</span></span>
====================
<span data-ttu-id="c2539-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="c2539-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
