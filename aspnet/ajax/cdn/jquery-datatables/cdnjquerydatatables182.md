...
---
<a name="jquery-datatables-182"></a><span data-ttu-id="5ea22-102">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="5ea22-102">jQuery DataTables 1.8.2</span></span>
====================
<span data-ttu-id="5ea22-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="5ea22-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
