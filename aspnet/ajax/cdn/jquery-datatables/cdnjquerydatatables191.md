...
ms.locfileid: "41828112"
---
<a name="jquery-datatables-191"></a><span data-ttu-id="2b4ac-102">jQuery 1.9.1 DataTables</span><span class="sxs-lookup"><span data-stu-id="2b4ac-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="2b4ac-103">I file seguenti per il componente aggiuntivo jQuery DataTables i plug-in sono ospitati nella rete CDN:</span><span class="sxs-lookup"><span data-stu-id="2b4ac-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
