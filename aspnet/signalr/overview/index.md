...
- [Guida all'API](guide-to-the-api/index.md)
    ...
    - [Guida all'API Hubs - Client JavaScript](guide-to-the-api/hubs-api-guide-javascript-client.md)
    - [Guida all'API Hubs - Client .NET (C#)](guide-to-the-api/hubs-api-guide-net-client.md)
    - [Comprensione e gestione degli eventi di durata della connessione in SignalR](guide-to-the-api/handling-connection-lifetime-events.md)
    - [Uso dei gruppi in SignalR](guide-to-the-api/working-with-groups.md)
    - [Mapping degli utenti di SignalR alle connessioni](guide-to-the-api/mapping-users-to-connections.md)
- [Test e debug](testing-and-debugging/index.md)

    - [Risoluzione dei problemi di SignalR](testing-and-debugging/troubleshooting.md)
    - [Unit test di applicazioni SignalR](testing-and-debugging/unit-testing-signalr-applications.md)
    - [Abilitazione della traccia di SignalR](testing-and-debugging/enabling-signalr-tracing.md)
- [Sicurezza](security/index.md)
    ...
    - [Autenticazione e autorizzazione per le connessioni persistenti di SignalR](security/persistent-connection-authorization.md)
...
- [Versioni](releases/index.md)
    ...
    - [Aggiornamento di progetti SignalR 1. x alla versione 2](releases/upgrading-signalr-1x-projects-to-20.md)
- [Versioni precedenti](older-versions/index.md)
    ...
    - [Guida all'API Hubs - Client .NET](older-versions/signalr-1x-hubs-api-guide-net-client.md)
    - [Comprensione e gestione degli eventi di durata della connessione in SignalR](older-versions/handling-connection-lifetime-events.md)
    - [Uso dei gruppi in SignalR 1.x](older-versions/working-with-groups.md)
    - [Mapping degli utenti di SignalR alle connessioni in SignalR 1.x](older-versions/mapping-users-to-connections.md)
    - [Introduzione alla sicurezza di SignalR (SignalR 1.x)](older-versions/introduction-to-security.md)
