...
<span data-ttu-id="60f87-127">I motivi per non effettua l'hosting in IIS includono:</span><span class="sxs-lookup"><span data-stu-id="60f87-127">Reasons for not hosting in IIS include:</span></span>
