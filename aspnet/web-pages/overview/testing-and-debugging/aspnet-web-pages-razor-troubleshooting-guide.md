...
ms.locfileid: "37825163"
---
<a name="aspnet-web-pages-razor-troubleshooting-guide"></a>ASP.NET Web Pages (Razor) Troubleshooting Guide
====================
...
Questo errore può verificarsi se il server non è configurato correttamente per l'uso di .NET Framework 4 o versione successiva e pertanto non riconosce il codice in `@{ }` blocchi. Vedere la descrizione in precedenza *HTTP Errore 403 - accesso negato: accesso negato*.
...
- <em>Cassetta postale non disponibile. Risposta del server: 5.1.0 &lt; someuser@invaliddomain &gt; mittente rifiutata: dominio mittente non valido</em>
