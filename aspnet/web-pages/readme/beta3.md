...
> 
> <span data-ttu-id="a58a3-180">Ad esempio, il seguente `@helper` sintassi funziona in versione Beta 3:</span><span class="sxs-lookup"><span data-stu-id="a58a3-180">For example, the following `@helper` syntax works in the Beta 3 release:</span></span>
> 
...
> <span data-ttu-id="a58a3-333">**Soluzione alternativa**</span><span class="sxs-lookup"><span data-stu-id="a58a3-333">**Workaround**</span></span>  
...
> <span data-ttu-id="a58a3-343">L'errore può verificarsi per diversi motivi.</span><span class="sxs-lookup"><span data-stu-id="a58a3-343">The error can occur for a number of reasons.</span></span> <span data-ttu-id="a58a3-344">Un motivo per cui che è possibile visualizzare questo errore è se lo script di database contiene un carattere di virgoletta singola (') e set di caratteri predefinito del database MySQL di destinazione non è presente in UTF-8.</span><span class="sxs-lookup"><span data-stu-id="a58a3-344">One reason you can see this error is if the database script contains a single quotation character (') and the destination MySQL database's default character set is not to UTF-8.</span></span>
> 
...
> <span data-ttu-id="a58a3-354">Passare a un'applicazione WCF genera un errore simile a quello seguente:</span><span class="sxs-lookup"><span data-stu-id="a58a3-354">Browsing to a WCF application results in an error like the following one:</span></span>
> 
...
> <span data-ttu-id="a58a3-390">Il **Foreign Key** nella finestra di dialogo non consente di immettere il nome della chiave primario della tabella di chiave primaria.</span><span class="sxs-lookup"><span data-stu-id="a58a3-390">The **Foreign Key** dialog box does not allow you to enter the primary key name from the primary key table.</span></span>
> 
...
> 
> <span data-ttu-id="a58a3-396">**Soluzione alternativa**</span><span class="sxs-lookup"><span data-stu-id="a58a3-396">**Workaround**</span></span>  
> <span data-ttu-id="a58a3-397">Nessuno.</span><span class="sxs-lookup"><span data-stu-id="a58a3-397">None.</span></span> <span data-ttu-id="a58a3-398">SQL Server Compact non supporta le relazioni tra tabelle.</span><span class="sxs-lookup"><span data-stu-id="a58a3-398">SQL Server Compact does not support relationships between tables.</span></span>


#### <a name="issue-parameterized-sql-queries-throw-exceptions"></a><span data-ttu-id="a58a3-399">Problema: Le query SQL con parametri vengono generate eccezioni</span><span class="sxs-lookup"><span data-stu-id="a58a3-399">Issue: Parameterized SQL queries throw exceptions</span></span>

> <span data-ttu-id="a58a3-400">In SQL Server Compact 4.0, se non si specifica un tipo di dati, ad esempio `SqlDbType` o `DbType` per i parametri nelle query con parametri, viene generata un'eccezione quando viene eseguita la query.</span><span class="sxs-lookup"><span data-stu-id="a58a3-400">In SQL Server Compact 4.0, if you do not specify a data type such as `SqlDbType` or `DbType` for parameters in parameterized queries, an exception is thrown when the query runs.</span></span>
> 
> <span data-ttu-id="a58a3-401">**Soluzione alternativa**</span><span class="sxs-lookup"><span data-stu-id="a58a3-401">**Workaround**</span></span>  
> <span data-ttu-id="a58a3-402">Impostare in modo esplicito il tipo di dati per i parametri, ad esempio `SqlDbType` o `DbType`.</span><span class="sxs-lookup"><span data-stu-id="a58a3-402">Explicitly set the data type for parameters such as `SqlDbType` or `DbType`.</span></span> <span data-ttu-id="a58a3-403">Questo aspetto è fondamentale nel caso di tipi di dati BLOB (`image` e `ntext`).</span><span class="sxs-lookup"><span data-stu-id="a58a3-403">This is critical in the case of BLOB data types (`image` and `ntext`).</span></span> <span data-ttu-id="a58a3-404">Usare codice simile al seguente:</span><span class="sxs-lookup"><span data-stu-id="a58a3-404">Use code like the following:</span></span>
> 
...
## <a name="for-more-information"></a><span data-ttu-id="a58a3-405">Ulteriori informazioni</span><span class="sxs-lookup"><span data-stu-id="a58a3-405">For More Information</span></span>

<span data-ttu-id="a58a3-406">Per ulteriori informazioni su WebMatrix Beta 3, vedere i siti Web seguenti:</span><span class="sxs-lookup"><span data-stu-id="a58a3-406">For more information about WebMatrix Beta 3, see the following websites:</span></span>

- [<span data-ttu-id="a58a3-407">IIS.net</span><span class="sxs-lookup"><span data-stu-id="a58a3-407">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="a58a3-408">ASP.NET 2.0</span><span class="sxs-lookup"><span data-stu-id="a58a3-408">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="a58a3-409">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="a58a3-409">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

* * *

<span data-ttu-id="a58a3-410">© 2010 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="a58a3-410">© 2010 Microsoft Corporation.</span></span> <span data-ttu-id="a58a3-411">Tutti i diritti riservati.</span><span class="sxs-lookup"><span data-stu-id="a58a3-411">All Rights Reserved.</span></span> <span data-ttu-id="a58a3-412">[Le condizioni d'uso](https://msdn.microsoft.cos/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="a58a3-412">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
