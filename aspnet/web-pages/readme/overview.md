...
- [<span data-ttu-id="88afe-118">Per ulteriori informazioni</span><span class="sxs-lookup"><span data-stu-id="88afe-118">For More Information</span></span>](#More_Info)
...
> 
> - <span data-ttu-id="88afe-296">In Windows Vista o Windows 7, abilitare il controllo dell'account utente.</span><span class="sxs-lookup"><span data-stu-id="88afe-296">On Windows Vista or Windows 7, enable UAC.</span></span>
...
> 
> <span data-ttu-id="88afe-322">**Soluzione alternativa** </span><span class="sxs-lookup"><span data-stu-id="88afe-322">**Workaround** </span></span>  
...
> <span data-ttu-id="88afe-357">In alcune circostanze, la pubblicazione di un'applicazione genera un errore di "servizio non è disponibile".</span><span class="sxs-lookup"><span data-stu-id="88afe-357">Under some circumstances, publishing an application causes a "service is unavailable" error.</span></span>
> 
...
#### <a name="issue-download-published-site-fails-for-applications-that-have-browser-based-setup"></a><span data-ttu-id="88afe-414">Problema: "Sito di Download pubblicato" non riesce per le applicazioni che dispongono di un'installazione basata su browser</span><span class="sxs-lookup"><span data-stu-id="88afe-414">Issue: "Download published site" fails for applications that have browser-based setup</span></span>

> <span data-ttu-id="88afe-415">Alcune applicazioni (ad esempio, Kentico CMS) è necessario avviarli nel browser per eseguire il programma di installazione di post-installazione, ad esempio la creazione di un database.</span><span class="sxs-lookup"><span data-stu-id="88afe-415">Some applications (for example, Kentico CMS) require you to launch them in the browser in order to perform post-installation setup such as creating a database.</span></span> <span data-ttu-id="88afe-416">Se si pubblica un'applicazione simile al seguente senza completare l'installazione basata su browser, verrà eseguito il tentativo di scaricare lo stesso sito da un server remoto.</span><span class="sxs-lookup"><span data-stu-id="88afe-416">If you publish an application like this without completing the browser-based setup, attempting to download the same site from a remote server will fail.</span></span>
> 
> <span data-ttu-id="88afe-417">**Soluzione alternativa**</span><span class="sxs-lookup"><span data-stu-id="88afe-417">**Workaround**</span></span>  
> <span data-ttu-id="88afe-418">Completare l'installazione basata su browser prima di pubblicare il sito.</span><span class="sxs-lookup"><span data-stu-id="88afe-418">Finish browser-based setup before publishing the site.</span></span>


#### <a name="issue-download-published-site-fails-with-a-database-error-for-dotnetnuke-and-kooboo-cms"></a><span data-ttu-id="88afe-419">Problema: "Sito di Download pubblicato" viene generato un errore di database per DotNetNuke e Kooboo CMS</span><span class="sxs-lookup"><span data-stu-id="88afe-419">Issue: "Download published site" fails with a database error for DotNetNuke and Kooboo CMS</span></span>

> <span data-ttu-id="88afe-420">Se si tenta di scaricare un'applicazione da un server e si dispone delle credenziali nella stringa di connessione del database nel **impostazioni di pubblicazione** finestra di dialogo, si potrebbe vedere il seguente errore nel Registro di pubblicazione:</span><span class="sxs-lookup"><span data-stu-id="88afe-420">If you try to download an application from a server and you have administrator credentials in the database connection string in the **Publish Settings** dialog, you might see the following error in the publish log:</span></span>
> 
> [!code-console[Main](overview/samples/sample9.cmd)]
> 
> <span data-ttu-id="88afe-421">**Soluzione alternativa**</span><span class="sxs-lookup"><span data-stu-id="88afe-421">**Workaround**</span></span>  
> <span data-ttu-id="88afe-422">Se possibile, eseguire di nuovo il sito (o pubblicarlo) usando credenziali senza privilegi di amministratore per il database.</span><span class="sxs-lookup"><span data-stu-id="88afe-422">If practical, republish the site (or have it published) using non-administrator credentials for the database.</span></span>


<a id="More_Info"></a>

## <a name="for-more-information"></a><span data-ttu-id="88afe-423">Ulteriori informazioni</span><span class="sxs-lookup"><span data-stu-id="88afe-423">For More Information</span></span>

<span data-ttu-id="88afe-424">Per ulteriori informazioni su WebMatrix 1.0, vedere i siti Web seguenti:</span><span class="sxs-lookup"><span data-stu-id="88afe-424">For more information about WebMatrix 1.0, see the following websites:</span></span>

- [<span data-ttu-id="88afe-425">IIS.net</span><span class="sxs-lookup"><span data-stu-id="88afe-425">IIS.net</span></span>](http://iis.net/)
- [<span data-ttu-id="88afe-426">ASP.NET 2.0</span><span class="sxs-lookup"><span data-stu-id="88afe-426">ASP.NET</span></span>](https://asp.net/webmatrix)
- [<span data-ttu-id="88afe-427">Microsoft.com/web</span><span class="sxs-lookup"><span data-stu-id="88afe-427">Microsoft.com/web</span></span>](https://www.microsoft.com/web)

<span data-ttu-id="88afe-428">© 2011 Microsoft Corporation.</span><span class="sxs-lookup"><span data-stu-id="88afe-428">© 2011 Microsoft Corporation.</span></span> <span data-ttu-id="88afe-429">Tutti i diritti riservati.</span><span class="sxs-lookup"><span data-stu-id="88afe-429">All Rights Reserved.</span></span> <span data-ttu-id="88afe-430">[Condizioni di utilizzo](https://msdn.microsoft.cos/cc300389.aspx).</span><span class="sxs-lookup"><span data-stu-id="88afe-430">[Terms of Use](https://msdn.microsoft.cos/cc300389.aspx).</span></span>
